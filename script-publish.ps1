...
dotnet publish -c Release -f netcoreapp3.1 --self-contained true -p:PublishSingleFile=true -p:PublishTrimmed=true --runtime osx-x64 -o "./publish/MessageCommunicator (macOS 10.12)" ./MessageCommunicator.TestGui
...
Copy-Item "./publish/MessageCommunicator (macOS 10.12)/MessageCommunicator.TestGui" -Destination "./publish/MessageCommunicator-macOS-X64"
