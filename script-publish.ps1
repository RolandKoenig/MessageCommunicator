...
dotnet publish -c Release -f net5.0 --self-contained true -p:PublishSingleFile=true -p:PublishTrimmed=true -p:TrimMode=Link --runtime osx-x64 -o "./publish/MessageCommunicator (macOS 10.12 X64)" ./MessageCommunicator.TestGui
